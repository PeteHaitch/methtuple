These `BAM` files were created using Bismark (`v0.10.1`) and mapping against the hg19 reference genome. The `FASTQ` files and the __Bismark__ mapping reports are also included for completeness.
