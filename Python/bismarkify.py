...
# TODO: Rewrite main loop. Keep all reads in memory and then write to disk at the end instead of the current approach of writing each read to disk one-at-a-time.
...
## TODO: Test on data generated by Bismark and check that XM, XR and XG tags are identical between programs
